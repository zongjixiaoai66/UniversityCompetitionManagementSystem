...
public class SaishiTijiaoView extends SaishiTijiaoEntity implements Serializable {
	...
	*/
	...
	public SaishiTijiaoView() {

	}

	public SaishiTijiaoView(SaishiTijiaoEntity saishiTijiaoEntity) {
		try {
			BeanUtils.copyProperties(this, saishiTijiaoEntity);
	...
	*/
	...
	public String toString() {
		return "SaishiTijiaoView{" +
			", saishiTijiaoYesnoValue=" + saishiTijiaoYesnoValue +
