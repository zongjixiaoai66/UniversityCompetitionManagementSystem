...
var centerMenu = [
    ...
    ,{
        name: '赛事提交',
        url: '../saishiTijiao/list.html'
    }
    ,{
        name: '赛事报名',
        url: '../saishiYuyue/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/gaoxiaojingsaiguanlixitong/admin/dist/index.html#/login";
