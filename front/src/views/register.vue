    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">高校竞赛管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='zhuanjia'">
                                <el-input v-model="ruleForm.createTime" autocomplete="off" placeholder="创建时间"  />
                           </el-form-item>
                        -->
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/gaoxiaojingsaiguanlixitong/img/back-img-bg.jpg);
