               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="赛事编号" prop="saishiUuidNumber">
                       <el-input v-model="ruleForm.saishiUuidNumber"
                                 placeholder="赛事编号" clearable  :readonly="ro.saishiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="赛事地点" prop="saishiAddress">
                       <el-input v-model="ruleForm.saishiAddress"
                                 placeholder="赛事地点" clearable  :readonly="ro.saishiAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.saishiContent"  label="赛事介绍" prop="saishiContent">
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    saishiName: '',
                    saishiUuidNumber: new Date().getTime(),
                    saishiPhoto: '',
                    saishiAddress: '',
                    saishiTypes: '',
                    saishiContent: '',
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.saishiContent = _this.ruleForm.saishiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.saishiContent = this.ruleForm.saishiContent.replaceAll(this.$base.url,"");
                        this.$http({
