    ...
    <div class="addEdit-block">
        <el-form
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名唯一编号" prop="saishiTijiaoUuidNumber">
                       <el-input v-model="ruleForm.saishiTijiaoUuidNumber"
                                 placeholder="报名唯一编号" clearable  :readonly="ro.saishiTijiaoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="内容" prop="saishiTijiaoText">
                        <el-input type="textarea"  :readonly="ro.saishiTijiaoText" v-model="ruleForm.saishiTijiaoText" placeholder="内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.saishiTijiaoText" label="内容" prop="saishiTijiaoText">
                            <span v-html="ruleForm.saishiTijiaoText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.saishiShangchuanFile" label="赛事作品" prop="saishiShangchuanFile">
                        <file-upload
                                tip="点击上传赛事作品"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.saishiShangchuanFile?$base.url+ruleForm.saishiShangchuanFile:''"
                                @change="saishiShangchuanFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.saishiShangchuanFile" label="赛事作品" prop="saishiShangchuanFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.saishiShangchuanFile"  >赛事作品下载</a>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.saishiTijiaoYesnoTypes" label="提交状态" prop="saishiTijiaoYesnoTypes">
                        <el-input v-model="ruleForm.saishiTijiaoYesnoValue" placeholder="提交状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    saishiTijiaoUuidNumber: false,
                    saishiId: false,
                    laoshiId: false,
                    yonghuId: false,
                    saishiTijiaoText: false,
                    saishiShangchuanFile: false,
                    saishiTijiaoYesnoTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    saishiTijiaoUuidNumber: new Date().getTime(),
                    saishiId: '',
                    laoshiId: '',
                    yonghuId: '',
                    saishiTijiaoText: '',
                    saishiShangchuanFile: '',
                    saishiTijiaoYesnoTypes: '',
                    insertTime: '',
                },
                saishiTijiaoYesnoTypesOptions : [],
                laoshiOptions : [],
                saishiOptions : [],
                yonghuOptions : [],
                rules: {
                   saishiTijiaoUuidNumber: [
                   ...
                   saishiShangchuanFile: [
                              { required: true, message: '赛事作品不能为空', trigger: 'blur' },
                          ],
                   saishiTijiaoYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=saishi_tijiao_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.saishiTijiaoYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`saishiTijiao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.saishiTijiaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            saishiShangchuanFileUploadChange(fileUrls){
                this.ruleForm.saishiShangchuanFile = fileUrls;
                this.addEditUploadStyleChange()
            },
